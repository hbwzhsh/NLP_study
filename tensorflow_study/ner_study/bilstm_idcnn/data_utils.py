...
class BatchManager(object):
    ...
    def pad_data(data):
        ...
        strings = strings[0:max_length]
        chars= chars[0:max_length]
        segs = segs[0:max_length]
        targets = targets[0:max_length]
...
class TestBatchManager(object):
    ...
    def sort_and_pad(self, data, batch_size):
        ...
        batch_data = list()
        for i in range(num_batch):
            batch_data.append(self.pad_data(data[int(i*batch_size) : int((i+1)*batch_size)]))
        return batch_data
