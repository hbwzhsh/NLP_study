...
def word_mapping(sentences, lower):
    ...
    dico['<PAD>'] = 10000001
    dico['<UNK>'] = 10000000
    dico = {k: v for k, v in dico.items() if v >= 3}  # 只保留字频大于3的字
...
def random_batch(batch_size, train_data, singletons=[]):
    ...
    seq_pairs = sorted(zip(input_seqs, target_seqs, chars2_seqs),
    ...
    return input_padded, input_lengths, target_padded,\
           target_lengths, chars2_seqs_padded, chars2_seqs_lengths